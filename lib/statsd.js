...
Client.prototype.increment = function(stats, value, sample_rate, tags) {
    var self = this;
    self.update_stats(stats, value || 1, sample_rate, tags);
};

Client.prototype.decrement = function(stats, value, sample_rate, tags) {
    var self = this;
    self.update_stats(stats, -value || -1, sample_rate, tags);
};
